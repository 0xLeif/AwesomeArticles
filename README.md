...
- [Obscure Foundation Types](https://swiftrocks.com/useful-obscure-foundation-types-in-swift.html)

### Generate QR Code

- [QR Code Generation](https://medium.com/swift-programming/qr-code-generation-with-a-custom-logo-and-color-using-swift-e1d0a44adbe3)

### Dependency Injection

- [racecondition.software](https://racecondition.software/blog/dependency-injection/)

### Network

- [alamofire vs urlsession](https://medium.com/swift-programming/alamofire-vs-urlsession-a-comparison-for-networking-in-swift-c6cb3bc9f3b8)
- [Rule based logic](https://www.swiftbysundell.com/posts/rule-based-logic-in-swift)
...
- [Optional, Throws, Results](https://nshipster.com/optional-throws-result-async-await/?utm_source=mybridge&utm_medium=blog&utm_campaign=read_more)
...
### Rust vs Swift
- [Rust and Swift](https://v4.chriskrycho.com/rust-and-swift.html)
